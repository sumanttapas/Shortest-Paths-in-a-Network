Shortest Paths in a Network ReadME.txt
Author: Sumant Sanjay Tapas
Email ID: stapas@uncc.edu

Program and Data Structure design:

The project is implemented using python 3.4. It uses object oriented programming concepts in python. The initial graph is 
